...
class aspen_model():
    def __init__(self, aspen, export, change_list=['PRES', 'TEMP', 'FLOWRATE', 'SPLIT'], change_limit=0.10) -> None:
        self.aspen = aspen
    ...
    def generate_data_list(self, value, change_limit=None):
        ...
        if change_limit == None:
            ...
            if value == 0:
                # 0~3 10 points
                data_list = [i * 3 / 10 for i in range(1, 11)]
            else:
                for i in range(1, 11):
    ...
    def run_change_simulation(self, id_of_SEC=None, id_of_HEAT=None, change_operation=None):
        ...
        if id_of_SEC is not None:
            ...
            for value in value_list:
                ...
                # save the result
                self.exporter.save_result(f'SEC_PRES{id_of_SEC}_value={value}')
                print(f'The process of SEC_PRES{id_of_SEC}_value={value} has finished.')
        ...
        if id_of_HEAT is not None and change_operation == 'PRES':
            ...
            for value in value_list:
                ...
                print(f'The process of HEAT_{change_operation}{id_of_HEAT}_value={value} has finished.')
            # reset the setting parameter
            self.initial_parameter()
        ...
        if id_of_HEAT is not None and change_operation == 'TEMP':
            ...
            for value in value_list:
                ...
                # save the result
                self.exporter.save_result(f'HEAT_{change_operation}{id_of_HEAT}_value={value}')
                print(f'The process of HEAT_{change_operation}_{id_of_HEAT}_value={value} has finished.')
        ...
        if change_operation == 'FLOWRATE':
            ...
            for value in value_list:
                ...
                print(f'The process of FLOWRATE_value={value} has finished.')
        ...
        if change_operation == 'split_fraction':
            ...
            for value in value_list:
                ...
                print(f'The process of split_fraction_value={value} has finished.')
